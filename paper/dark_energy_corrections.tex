...
\begin{figure}
  ...
  evenly to aid visibility. The $k(z) = 1$ treatment, which represents the
  uncorrected values, is clearly non-linear while the $k(z) = 1 + z$ treatment
  which fixes the K-correction redshift error, appears to be linear.}
...
\begin{figure}
  ...
  \sim Norm(65.94, 1.30^2)$.
  }
\label{fig:H0bootstrap}
\end{figure}

The value estimated here, $H_0 \sim 65.94 \pm 1.30$ is highly suspicious
