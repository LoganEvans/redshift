...
\title{Correcting K-correction: restoring the time dilation term and fixing the
inverted zero-point term removes accelerating expansion and resolves the Hubble
tension}
...
equation used in modern cosmology contains three errors. The oldest of these
...
Only once the data is cleaned can cosmological parameters, such as those used
by the Friedmann-Lema\^{i}tre-Robertson-Walker (FLRW) metric or the
$\Lambda$-CDM model, be reevaluated.
